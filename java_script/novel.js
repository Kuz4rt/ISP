...
let ArrayQuest = {
    ...
    4.63: {
        name: "Парень 2",
        text: "Ну, не обязательно рептилоиды… Хотя… Никогда не знаешь наверняка. Я говорю о мировом правительстве! Они уже близко к захвату!",
        img: ['../image/novell/roof_guys.png'],
        next: ['4.64', '...'],
    },
    ...
    6: {
        name: "Катя",
        text: "Ой привет привет, я вчера всё таки поиграла в ту новеллу что ты мне говорил, она мне так понравилась, хотя обычно я не очень люблю такой жанр, там же куча текста, статичные картинки и весь геймплей сводиться к нажиманию левой кнопки мыши или выбора какого нибудь варината раз в десять часов.",
