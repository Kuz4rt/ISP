...
let ArrayQuest = {
    ...
    4: {
        ...
        next: ['4.1', 'Подняться наверх', '5', 'Спуститься вниз'],
    },
    ...
    6: {
        name: "Катя",
        text: "Ой, привет привет, я вчера все-таки поиграла в ту новеллу, что ты мне говорил, она мне так понравилась, хотя обычно я не очень люблю такой жанр, там же куча текста, статичные картинки и весь геймплей сводится к нажиманию левой кнопки мыши или выбора какого-нибудь варианта раз в десять часов.",
